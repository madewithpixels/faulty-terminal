...
<script src="https://cdn.jsdelivr.net/gh/madewithpixels/faulty-terminal@v1.7.1/dist/faulty-terminal.min.js"></script>
```
...
| URL form | Behaviour |
|----------|-----------|
| `@v1.7.1` | frozen to one build **(recommended)** |
...
and stay blank until the reveal arrives.
